...
class REG_Data:
    ...
    def timeslice(self, idx):
        ...
        copy_keys = ['_n_predictor_variables', 'basis', 'filter_length', 'tstart', 'tstep', 'tstop', '_stim_is_single',
                     '_stim_dims', '_stim_names', 's_baseline', 's_scaling', '_prewhitened', 's_normalization']
...
class ncRF:
    ...
    _PICKLE_ATTRS = ('_basis', '_cv_results', 'mu',  '_name', '_stim_is_single', '_stim_dims', '_stim_names',
                     ...
                     '_stim_baseline', '_stim_scaling', 'lead_field_scaling', 'residual', 'source', 'space', 'theta',
                     'tstart', 'tstep', 'tstop', '_stim_normalization')
